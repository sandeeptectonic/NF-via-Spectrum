...
class VariantSelects extends HTMLElement {
  ...
  renderProductInfo() {
    ...
    const priceNote = priceContainer.dataset.priceNote;
    const priceNoteText = priceContainer.dataset.priceNoteText;
    ...
    if (priceContainer) {
      const variantPrice = `
        ...
        ${ this.currentVariant.compare_at_price > this.currentVariant.price && priceNote === 'false' ? `
        ...
        ${ priceNote === 'true' ? `
          <span class="price-note">
              <p class="label__text">${priceNoteText}</p>
          </span>
        ` : ''}
      `;
    ...
    if (labelContainer && priceNote === 'false') {
